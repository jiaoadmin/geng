<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:72:"D:\phpstudy\WWW\myshop\public/../application/index\view\index\index.html";i:1551091917;s:67:"D:\phpstudy\WWW\myshop\public/../application/index\view\layout.html";i:1550994806;s:74:"D:\phpstudy\WWW\myshop\public/../application/index\view\public\header.html";i:1551442559;s:71:"D:\phpstudy\WWW\myshop\public/../application/index\view\public\top.html";i:1551081595;s:74:"D:\phpstudy\WWW\myshop\public/../application/index\view\public\footer.html";i:1548050592;}*/ ?>
...
<div class="soubg">
  <div class="sou">
    ...
    <span class="fr">
        ...
        <a href="<?php echo url('Login/register'); ?>" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|
        <?php else: ?>
        欢迎 <font color='blur'><?php echo \think\Session::get('userInfo.user_name'); ?></font>登录
        <?php endif; ?>|
          ...
          <a href="<?php echo url('User/index'); ?>">个人中心</a>
            <div class="ss_list_bg">
              <div class="s_city_t"></div>
                <div class="ss_list_c">
                  <ul>
                    <li><a href="<?php echo url('Login/quit'); ?>">退了</a></li>
...
<div class="menu_bg">
    <div class="menu">
        ...
        <ul class="menu_r">                                                              
            ...
            <li><a href="<?php echo url('Goods/goodsList'); ?>?cate_id=<?php echo $v['cate_id']; ?>"><?php echo $v['cate_name']; ?></a></li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
...
<div class="i_bg bg_color">
    ...
    <!--Begin 进口 生鲜 Begin-->
    <div cate_id = "<?php echo $floorInfo['topCate']['cate_id']; ?>">
        <div class="i_t mar_10">
            <span class="floor_num"><font class="floorNum">1</font>F</span>
            ...
            <div class="fresh_mid">
                <ul>
                    ...
                    <li>
                        ...
                        <div class="img"><a href="<?php echo url('Goods/goodsDetail'); ?>?goods_id=<?php echo $v['goods_id']; ?>"><img src="__STATIC__/../goodsimg/<?php echo $v['goods_img']; ?>" width="185" height="155" /></a></div>
                    </li>   
                    <?php endforeach; endif; else: echo "" ;endif; ?>                                    
                </ul>
            </div>
...
<script>
    $(function(){
        $('#getMore').click(function(){
            var _this = $(this);
            var floor_num = _this.prev("div").find("font[class='floorNum']").text();
            var cate_id = _this.prev("div").attr('cate_id');
            // console.log(floor_num);
            // console.log(cate_id);
            $.post(
                "<?php echo url('Index/getMoreFloorInfo'); ?>",
